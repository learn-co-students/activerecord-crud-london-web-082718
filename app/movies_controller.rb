...
def can_be_created_with_a_hash_of_attributes
  ...
  movie = Movie.new(attributes) # hash of attributes
  movie.save
  movie
end
...
def can_get_size_of_the_database
  Movie.count    # size of DB is same as COUNT - length and size are N/A
end
...
def can_find_using_where_clause_and_be_sorted
  ...
  # DIFFERENT READ METHODS - 5.2 Read -
